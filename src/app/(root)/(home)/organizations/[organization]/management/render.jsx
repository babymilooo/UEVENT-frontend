...
const Render = () => {
    ...
    return (
        <div className='grid grid-cols-4 bg-muted h-full'>
            <div className=" col-span-3 rounded-md mt-2 flex flex-col">
            ...
            <div className="col-span-1 z-10 h-full">
                <div className="flex flex-col fixed h-full m-2">
                    <div className="bg-background h-full rounded-md">
                        <div className="relative flex h-[360px] w-full items-end bg-cover bg-center select-none overflow-hidden rounded-t-md"
                            style={{
